    ...
    public class DevicesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Devices != null ? 
                          ...
                          Problem("Entity set 'GearNetContext.Devices'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("DeviceId,DeviceName,DeviceType,IsCheckedOut")] Device device)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DeviceId,DeviceName,DeviceType,IsCheckedOut")] Device device)
        {
